...
```bash
git clone git@github.com:apaulinhacarlos/project28-stranger-things-frontend.git
```

```bash
git clone git@github.com:apaulinhacarlos/project28-stranger-things-backend.git
```

Acesse os diretórios dos dois projetos com o comando `cd`:

```bash
cd project28-stranger-things-frontend
```

```bash
cd project28-stranger-things-backend
```
...
- [Repositório com o frontend](https://github.com/apaulinhacarlos/project28-stranger-things-frontend);

- [Repositório com o backend](https://github.com/apaulinhacarlos/project28-stranger-things-backend).
